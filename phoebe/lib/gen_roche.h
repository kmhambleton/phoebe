  ...
  */
  ...
  T left_lobe_left_xborder(
    ...
    if (w > 100) {
      ...
      return polish_xborder<T,real>(w, q, b, t);
    }
    ...
    if (method == 0) {  // Bisection on [-|l|,0]
      ...
      real a[5] = {2, 2*(1 + q - w), 2*(q - w), b + 2*q, b};
  ...
  */
  ...
  T right_lobe_left_xborder(
    ...
    if (r > 100 && r > 2*p){  // w->infty
      ...
      return polish_xborder<T,real>(w, q, b, 1 - t);
    }
    ...
    if (method == 0) {  // Bisection on [l, 1]
      ...
      real a[5] = {2, 2*(-1 + p - r), 2*(1 - c + r), 2 + 3*c, -c};
...
// #define DEBUG
  ...
  T right_lobe_right_xborder(
    ...
    if (method == 0) { // Bisection on [1, l]
      ...
      real f, x[2] = {1, l};   // signs on boundary: +, -
...
//      G = 0,                          // = partial_phi A
  ...
  */
  ...
  void critical_area_volume_integration(
    ...
    // clear k to avoid compiler warnings
    for (int i = 0; i < 4; ++i)
